...
module design_1
   (HDMI_CLK_N,
    ...
    sys_clk_p,
    sys_rst);
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.HDMI_CLK_N CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.HDMI_CLK_N, CLK_DOMAIN design_1_displayModule_0_1_HDMI_CLK_N, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output HDMI_CLK_N;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.HDMI_CLK_P CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.HDMI_CLK_P, CLK_DOMAIN design_1_displayModule_0_1_HDMI_CLK_P, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output HDMI_CLK_P;
  output [2:0]HDMI_D_N;
  output [2:0]HDMI_D_P;
  output [15:0]LED;
  input [15:1]SW;
  ...
  wire [6:0]axi_vga_0_data;
  wire clk_wiz_0_clk125MHz;
  wire clk_wiz_0_clk25MHz;
  wire clk_wiz_0_locked;
  wire displayModule_0_HDMI_CLK_N;
  wire displayModule_0_HDMI_CLK_P;
  wire [2:0]displayModule_0_HDMI_D_N;
  wire [2:0]displayModule_0_HDMI_D_P;
  ...
  assign HDMI_CLK_N = displayModule_0_HDMI_CLK_N;
  assign HDMI_CLK_P = displayModule_0_HDMI_CLK_P;
  assign HDMI_D_N[2:0] = displayModule_0_HDMI_D_N;
  assign HDMI_D_P[2:0] = displayModule_0_HDMI_D_P;
  ...
  design_1_axi_vga_0_1 axi_vga_0
       (.data(axi_vga_0_data),
        .s00_axi_aclk(microblaze_riscv_0_Clk),
        .s00_axi_araddr(smartconnect_1_M05_AXI_ARADDR),
        .s00_axi_aresetn(rst_clk_wiz_1_100M_peripheral_aresetn),
        .s00_axi_arprot(smartconnect_1_M05_AXI_ARPROT),
        .s00_axi_arready(smartconnect_1_M05_AXI_ARREADY),
        .s00_axi_arvalid(smartconnect_1_M05_AXI_ARVALID),
        .s00_axi_awaddr(smartconnect_1_M05_AXI_AWADDR),
        .s00_axi_awprot(smartconnect_1_M05_AXI_AWPROT),
        .s00_axi_awready(smartconnect_1_M05_AXI_AWREADY),
        .s00_axi_awvalid(smartconnect_1_M05_AXI_AWVALID),
        .s00_axi_bready(smartconnect_1_M05_AXI_BREADY),
        .s00_axi_bresp(smartconnect_1_M05_AXI_BRESP),
        .s00_axi_bvalid(smartconnect_1_M05_AXI_BVALID),
        .s00_axi_rdata(smartconnect_1_M05_AXI_RDATA),
        .s00_axi_rready(smartconnect_1_M05_AXI_RREADY),
        .s00_axi_rresp(smartconnect_1_M05_AXI_RRESP),
        .s00_axi_rvalid(smartconnect_1_M05_AXI_RVALID),
        .s00_axi_wdata(smartconnect_1_M05_AXI_WDATA),
        .s00_axi_wready(smartconnect_1_M05_AXI_WREADY),
        .s00_axi_wstrb(smartconnect_1_M05_AXI_WSTRB),
        .s00_axi_wvalid(smartconnect_1_M05_AXI_WVALID));
  ...
  design_1_displayModule_0_1 displayModule_0
       (.HDMI_CLK_N(displayModule_0_HDMI_CLK_N),
        .HDMI_CLK_P(displayModule_0_HDMI_CLK_P),
        .HDMI_D_N(displayModule_0_HDMI_D_N),
        .HDMI_D_P(displayModule_0_HDMI_D_P),
        .asciiValue(axi_vga_0_data),
        .locked(clk_wiz_0_locked),
