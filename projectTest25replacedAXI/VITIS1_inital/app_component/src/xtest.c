...
#define VGA_ASCII *((uint32_t *) 0x40080008)
#define VGA_GRIDLOC *((uint32_t *) 0x40080000)
#define VGA_WEN *((uint32_t *) 0x40090000)
#define FREQ *((uint32_t *) 0x40070000)
#define AMP_PERC *((uint32_t *) 0x40070008)
