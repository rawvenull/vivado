...
HD_PWD='C:/Xilinx/Vivado/EE415/projectTest25replacedAXI/projectTest25replacedAXI.runs/design_1_VGA_0_1_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_VGA_0_1.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_VGA_0_1.tcl
