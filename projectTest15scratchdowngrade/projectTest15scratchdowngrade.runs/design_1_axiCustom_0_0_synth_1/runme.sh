...
HD_PWD='C:/Xilinx/Vivado/EE415/projectTest15scratchdowngrade/projectTest15scratchdowngrade.runs/design_1_axiCustom_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axiCustom_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axiCustom_0_0.tcl
