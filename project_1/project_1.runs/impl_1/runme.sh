...
HD_PWD='C:/Xilinx/Vivado/EE415/project_1/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log combinedAudio.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source combinedAudio.tcl -notrace
