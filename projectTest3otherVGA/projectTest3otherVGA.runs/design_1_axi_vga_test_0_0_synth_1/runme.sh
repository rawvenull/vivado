...
HD_PWD='C:/Xilinx/Vivado/EE415/projectTest3/projectTest3.runs/design_1_axi_vga_test_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_vga_test_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_vga_test_0_0.tcl
