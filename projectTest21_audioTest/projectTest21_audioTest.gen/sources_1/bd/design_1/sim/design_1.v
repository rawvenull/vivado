...
module design_1
  ...
  wire [3:0]ledtest_0_D0_AN;
  wire [7:0]ledtest_0_D0_SEG;
  wire [3:0]ledtest_0_D1_AN;
  wire [7:0]ledtest_0_D1_SEG;
  wire [15:0]ledtest_0_LED;
  wire [2:0]ledtest_0_RGB0;
  wire [2:0]ledtest_0_RGB1;
  ...
  assign D0_AN[3:0] = ledtest_0_D0_AN;
  assign D0_SEG[7:0] = ledtest_0_D0_SEG;
  assign D1_AN[3:0] = ledtest_0_D1_AN;
  assign D1_SEG[7:0] = ledtest_0_D1_SEG;
  assign LED[15:0] = ledtest_0_LED;
  assign RGB0[2:0] = ledtest_0_RGB0;
  assign RGB1[2:0] = ledtest_0_RGB1;
  assign SW_1 = SW[15:1];
  ...
  design_1_ledtest_0_0 ledtest_0
       (.BTN(BTN_0_1),
        .D0_AN(ledtest_0_D0_AN),
        .D0_SEG(ledtest_0_D0_SEG),
        .D1_AN(ledtest_0_D1_AN),
        .D1_SEG(ledtest_0_D1_SEG),
        .LED(ledtest_0_LED),
        .RGB0(ledtest_0_RGB0),
        .RGB1(ledtest_0_RGB1),
        .SW(SW_1),
