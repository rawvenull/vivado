...
architecture STRUCTURE of design_1_xbar_0_axi_crossbar_v2_1_32_addr_arbiter_sasd is
  ...
  attribute SOFT_HLUTNM of \m_atarget_enc[2]_i_6\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[12]_i_6\ : label is "soft_lutpair0";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[3]_i_3\ : label is "soft_lutpair29";
  ...
  attribute SOFT_HLUTNM of \m_atarget_hot[7]_i_3\ : label is "soft_lutpair29";
...
\m_atarget_enc[2]_i_7\: unisim.vcomponents.LUT6
    generic map(
      ...
      I5 => \m_atarget_enc[2]_i_9_n_0\,
      O => \m_atarget_enc[2]_i_7_n_0\
    );
\m_atarget_enc[2]_i_8\: unisim.vcomponents.LUT6
    generic map(
...
architecture STRUCTURE of design_1_xbar_0_axi_register_slice_v2_1_31_axic_register_slice is
  ...
  attribute SOFT_HLUTNM of \m_payload_i[13]_i_5\ : label is "soft_lutpair54";
  ...
  attribute SOFT_HLUTNM of \m_payload_i[1]_i_3\ : label is "soft_lutpair51";
  ...
  attribute SOFT_HLUTNM of \m_payload_i[33]_i_3\ : label is "soft_lutpair49";
  attribute SOFT_HLUTNM of \m_payload_i[33]_i_7\ : label is "soft_lutpair54";
  attribute SOFT_HLUTNM of \m_payload_i[34]_i_10\ : label is "soft_lutpair49";
  ...
  attribute SOFT_HLUTNM of \skid_buffer[32]_i_2\ : label is "soft_lutpair52";
begin
  aa_rready <= \^aa_rready\;
...
addr_arbiter_inst: entity work.design_1_xbar_0_axi_crossbar_v2_1_32_addr_arbiter_sasd
     port map (
      ...
      \gen_arbiter.any_grant_reg_inv_0\(11 downto 4) => m_atarget_hot0(12 downto 5),
      \gen_arbiter.any_grant_reg_inv_0\(3 downto 0) => m_atarget_hot0(3 downto 0),
      \gen_arbiter.m_grant_hot_i[1]_i_2_0\ => splitter_aw_n_4,
      \gen_arbiter.m_grant_hot_i[1]_i_2_1\ => \gen_decerr.decerr_slave_inst_n_5\,
      \gen_arbiter.m_grant_hot_i[1]_i_2_2\ => splitter_aw_n_6,
      \gen_arbiter.m_grant_hot_i[1]_i_2_3\ => splitter_aw_n_2,
      \gen_axilite.s_axi_bvalid_i_reg\(11 downto 4) => m_atarget_hot(12 downto 5),
      \gen_axilite.s_axi_bvalid_i_reg\(3 downto 0) => m_atarget_hot(3 downto 0),
      \m_atarget_hot_reg[12]\ => addr_arbiter_inst_n_148,
      \m_atarget_hot_reg[12]_0\ => addr_arbiter_inst_n_149,
      ...
      \m_ready_d[1]_i_3_0\ => reg_slice_r_n_11,
      ...
      \m_ready_d_reg[0]_1\(0) => reg_slice_r_n_63,
      ...
      \m_ready_d_reg[2]_5\ => reg_slice_r_n_8,
      m_valid_i_reg(1) => reg_slice_r_n_27,
      m_valid_i_reg(0) => reg_slice_r_n_28,
...
\gen_decerr.decerr_slave_inst\: entity work.design_1_xbar_0_axi_crossbar_v2_1_32_decerr_slave
     port map (
      ...
      aclk => aclk,
      aresetn_d => aresetn_d,
      \gen_arbiter.m_grant_hot_i[1]_i_5\ => reg_slice_r_n_3,
      \gen_axilite.s_axi_awready_i_reg_0\ => \gen_decerr.decerr_slave_inst_n_6\,
      \gen_axilite.s_axi_awready_i_reg_1\ => addr_arbiter_inst_n_149,
      ...
      \m_ready_d[2]_i_3\ => reg_slice_r_n_11,
      \m_ready_d[2]_i_4\ => splitter_aw_n_11,
      \m_ready_d[2]_i_4_0\ => splitter_aw_n_0,
      ...
      \s_axi_wready[0]_0\ => reg_slice_r_n_5,
...
reg_slice_r: entity work.design_1_xbar_0_axi_register_slice_v2_1_31_axic_register_slice
     port map (
      ...
      aa_rready => aa_rready,
      aclk => aclk,
      \aresetn_d_reg[1]_0\(1) => reg_slice_r_n_27,
      \aresetn_d_reg[1]_0\(0) => reg_slice_r_n_28,
      ...
      \m_atarget_enc_reg[1]_3\ => reg_slice_r_n_10,
      ...
      \m_axi_rready[11]\(10 downto 4) => m_atarget_hot(11 downto 5),
      \m_axi_rready[11]\(3 downto 0) => m_atarget_hot(3 downto 0),
      ...
      \m_axi_rvalid[11]\ => reg_slice_r_n_13,
      m_axi_rvalid_8_sp_1 => reg_slice_r_n_12,
      \m_payload_i_reg[34]_0\(34 downto 1) => \m_payload_i_reg[34]\(33 downto 0),
      \m_payload_i_reg[34]_0\(0) => reg_slice_r_n_63,
...
splitter_ar: entity work.\design_1_xbar_0_axi_crossbar_v2_1_32_splitter__parameterized0\
     port map (
      Q(3 downto 0) => m_atarget_enc(3 downto 0),
      aclk => aclk,
      m_axi_arready(6) => m_axi_arready(11),
...
entity design_1_xbar_0_axi_crossbar_v2_1_32_axi_crossbar is
  ...
  attribute C_M_AXI_ADDR_WIDTH of design_1_xbar_0_axi_crossbar_v2_1_32_axi_crossbar : entity is "384'";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of design_1_xbar_0_axi_crossbar_v2_1_32_axi_crossbar : entity is "768'";
  ...
  attribute C_NUM_MASTER_SLOTS of design_1_xbar_0_axi_crossbar_v2_1_32_axi_crossbar : entity is 12;
  ...
  attribute P_M_AXI_SUPPORTS_READ of design_1_xbar_0_axi_crossbar_v2_1_32_axi_crossbar : entity is "12'b111111111111";
  attribute P_M_AXI_SUPPORTS_WRITE : string;
  attribute P_M_AXI_SUPPORTS_WRITE of design_1_xbar_0_axi_crossbar_v2_1_32_axi_crossbar : entity is "12'b111111111111";
  ...
  attribute P_S_AXI_SUPPORTS_WRITE of design_1_xbar_0_axi_crossbar_v2_1_32_axi_crossbar : entity is "2'b01";
...
begin
  ...
  m_axi_arvalid(11 downto 5) <= \^m_axi_arvalid\(11 downto 5);
  ...
  m_axi_awvalid(11 downto 5) <= \^m_axi_awvalid\(11 downto 5);
  m_axi_awvalid(4) <= \<const0>\;
  m_axi_awvalid(3 downto 0) <= \^m_axi_awvalid\(3 downto 0);
  m_axi_bready(11 downto 5) <= \^m_axi_bready\(11 downto 5);
  m_axi_bready(4) <= \<const0>\;
  m_axi_bready(3 downto 0) <= \^m_axi_bready\(3 downto 0);
  m_axi_rready(11 downto 5) <= \^m_axi_rready\(11 downto 5);
  ...
  m_axi_wvalid(11 downto 5) <= \^m_axi_wvalid\(11 downto 5);
...
\gen_sasd.crossbar_sasd_0\: entity work.design_1_xbar_0_axi_crossbar_v2_1_32_crossbar_sasd
     port map (
      ...
      m_axi_arvalid(10 downto 4) => \^m_axi_arvalid\(11 downto 5),
      m_axi_arvalid(3 downto 0) => \^m_axi_arvalid\(3 downto 0),
      m_axi_awready(11 downto 0) => m_axi_awready(11 downto 0),
      m_axi_awvalid(10 downto 4) => \^m_axi_awvalid\(11 downto 5),
      m_axi_awvalid(3 downto 0) => \^m_axi_awvalid\(3 downto 0),
      m_axi_bready(10 downto 4) => \^m_axi_bready\(11 downto 5),
      m_axi_bready(3 downto 0) => \^m_axi_bready\(3 downto 0),
      m_axi_bresp(23 downto 0) => m_axi_bresp(23 downto 0),
      m_axi_bvalid(11 downto 0) => m_axi_bvalid(11 downto 0),
      m_axi_rdata(383 downto 0) => m_axi_rdata(383 downto 0),
      m_axi_rready(10 downto 4) => \^m_axi_rready\(11 downto 5),
      m_axi_rready(3 downto 0) => \^m_axi_rready\(3 downto 0),
      m_axi_rresp(23 downto 0) => m_axi_rresp(23 downto 0),
      ...
      m_axi_wstrb(3 downto 0) => \^m_axi_wstrb\(47 downto 44),
      m_axi_wvalid(10 downto 4) => \^m_axi_wvalid\(11 downto 5),
      m_axi_wvalid(3 downto 0) => \^m_axi_wvalid\(3 downto 0),
...
architecture STRUCTURE of design_1_xbar_0 is
  ...
  attribute C_M_AXI_ADDR_WIDTH : string;
  attribute C_M_AXI_ADDR_WIDTH of inst : label is "384'";
  attribute C_M_AXI_BASE_ADDR : string;
  attribute C_M_AXI_BASE_ADDR of inst : label is "768'";
  attribute C_M_AXI_READ_CONNECTIVITY : string;
