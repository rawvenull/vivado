...
(* CORE_GENERATION_INFO = "design_1,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=design_1,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=22,numReposBlks=22,numNonXlnxBlks=2,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=2,numPkgbdBlks=0,bdsource=USER,da_axi4_cnt=7,da_board_cnt=1,da_mb_cnt=3,da_microblaze_riscv_cnt=1,synth_mode=Hierarchical}" *) (* HW_HANDOFF = "design_1.hwdef" *) 
module design_1
   (BTN,
    D0_AN,
    D0_SEG,
  ...
  output [3:0]D1_AN;
  output [7:0]D1_SEG;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.HDMI_CLK_N CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.HDMI_CLK_N, CLK_DOMAIN design_1_displayModule_0_2_HDMI_CLK_N, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output HDMI_CLK_N;
  (* X_INTERFACE_INFO = "xilinx.com:signal:clock:1.0 CLK.HDMI_CLK_P CLK" *) (* X_INTERFACE_PARAMETER = "XIL_INTERFACENAME CLK.HDMI_CLK_P, CLK_DOMAIN design_1_displayModule_0_2_HDMI_CLK_P, FREQ_HZ 100000000, FREQ_TOLERANCE_HZ 0, INSERT_VIP 0, PHASE 0.0" *) output HDMI_CLK_P;
  output [2:0]HDMI_D_N;
  output [2:0]HDMI_D_P;
  output [15:0]LED;
  ...
  wire [10:0]axi_vga_0_addr;
  wire [6:0]axi_vga_0_ampPercent;
  wire [6:0]axi_vga_0_data;
  wire [26:0]axi_vga_0_freq;
  wire axi_vga_0_we;
  ...
  design_1_VGA_0_0 VGA_0
       (.ascii_code(axi_vga_0_data),
        .char_pos(axi_vga_0_addr),
  ...
  design_1_axi_vga_0_1 axi_Custom
       (.addr(axi_vga_0_addr),
        .ampPercent(axi_vga_0_ampPercent),
        .data(axi_vga_0_data),
        .freq(axi_vga_0_freq),
