...
HD_PWD='C:/Xilinx/Vivado/EE415/projectTest23Combined/projectTest23Combined.runs/design_1_combinedAudio_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_combinedAudio_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_combinedAudio_0_0.tcl
